...
<section className="bg-black py-12 px-6 pb-24 text-green-100">
  <div className="max-w-3xl mx-auto">
    <h3 className="text-3xl font-bold text-green-300 mb-6">Apply for {job.title}</h3>

    <p className="mb-4 text-green-400">
      Fill in your details below to apply. Make sure to upload your updated resume and briefly describe why you’re a great fit for this role.
    </p>
  ...
  <>
    ...
    >
      <div className="bg-black text-white border border-white px-10 py-8 rounded-2xl shadow-2xl w-[90%] max-w-xl text-center backdrop-blur-md">
        <h2 className={`text-2xl font-bold mb-4 ${status.error ? "text-red-400" : "text-green-400"}`}>
        {status.error ? "Oops! Something Went Wrong" : "🎉 Application Submitted Successfully"}
      </h2>
      ...
      <p className="text-lg mb-4">
        {status.error ? (
          ...
          <>
            ...
            <br />
            Our team will review your application and contact you if you’re shortlisted.
          </>
        )}
      </p>

      <button
        onClick={() => setStatus({ loading: false, message: "", error: false })}
